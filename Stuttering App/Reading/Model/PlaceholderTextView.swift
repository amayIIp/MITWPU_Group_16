...
/**
 A custom subclass of UITextView that adds placeholder text functionality.
 
 You can set the placeholder text and color directly in the Storyboard
 Attributes Inspector using the @IBInspectable properties.
 */
