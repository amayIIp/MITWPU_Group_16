...
class WarmUpOnboarding: UIViewController {
    ...
    @IBAction func proceedToNextScreenTapped(_ sender: UIButton) {
        ...
        guard let nextVC = storyboard.instantiateViewController(withIdentifier: "WarmUpListViewController") as? WarmUpListViewController else {
